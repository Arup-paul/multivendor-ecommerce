...
if (!function_exists('get_option')) {
     ...
     * @return mixed
     */
    function get_option($key, bool $decode = false, $locale = null, $associative = false): mixed
    {
...
if (!function_exists('user_currency')) {
    ...
    {
        return default_currency(null, Currency::find(Auth::user()->setting['currency'] ?? null));
    }
}
