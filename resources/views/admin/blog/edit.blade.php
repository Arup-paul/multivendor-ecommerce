        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body "  >
                        <form method="POST" action="{{route('admin.blogs.update',$blog->id)}}" class="ajaxform"  >
                            @csrf
                            @method('PUT')
                            ...
                            {{ mediasection([
                                      'input_name' => 'image',
                                      'input_id' => 'image',
                                      'preview' => $blog->image ?? null,
                                      'value' => $blog->image ?? null,
                          ]) }}
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$blog->meta_description}}"  name="meta_description" class="form-control"   >
                            </div>
                            <div class="form-group">
                                <label for="name" class="required">{{ __('Meta Keywords') }} </label>
                                <input type="text" value="{{$blog->meta_keywords}}"  name="meta_keywords" class="form-control"   >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="0" @selected($blog->status == 0)>{{ __('Inactive') }}</option>
                                </select>
                            </div>
