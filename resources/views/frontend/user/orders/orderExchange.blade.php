            ...
            <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                ...
                <div class="signin-container user-container  panel  ">
                    <div class="panel-body ">
                        <h4>Order Exchange Reason</h4>
                        <form action="{{route('user.orders.exchange',$id)}}" name="frm-login" class="ajaxform" method="post">
                            @csrf

                             <div class="row">
                                 <div class="col-md-6">
                                     <p class="form-row">
                                         <label for="address_type">Product Info<span class="required">*</span></label>
                                         <select name="product_info" class="form-control" id="exchangeProduct">
                                             <option value="">Select Product</option>
                                             @foreach($order->orderProducts as $item)
                                                 <option value="{{$item->size}}-{{$item->product->id}}">{{$item->product->product_code}}--{{$item->size}}</option>
                                             @endforeach
                                         </select>
                                     </p>
                                 </div>
                                 <div class="col-md-6">
                                     <p class="form-row">
                                         <label for="address_type">Required Size <span class="required">*</span></label>
                                         <select name="required_size" id="productSizes" class="form-control productSizes">
                                 ...
                                 <div class="col-md-6">
                                     <p class="form-row">
                                         ...
                                         <select name="reason" class="form-control">
                                             ...
                                             <option value="Performance of Quality not adequate">Performance of Quality not adequate</option>
                                 ...
                                 <div class="col-md-6">
                                     <p class="form-row">
                                         <label for="address_type">Comments<span class="required">*</span></label>
...
@section('frontend_scripts')
    <script>
        $("#exchangeProduct").change(function (){
            ...
            $.ajax({
                ...
                success:function (res){
                    $("#productSizes").html(res)
                },error:function (e){
                    $("#productSizes").html('<option value="">Select Required Size</option>')
                }
            })
