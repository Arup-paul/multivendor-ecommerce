            ...
            <div class="col-md-6 col-md-offset-3  col-sm-12 col-xs-12">
                <div class="signin-container  panel ">
                    ...
                    <div class="login-header ">
                        ...
                        <small>Already Member? <a href="{{route('seller.login')}}" class=" "> Sign In </a>here</small>
                    </div>

                    <form action="{{route('seller.register')}}" name="frm-login" class="ajaxform" method="post">
                        @csrf
                        <p class="form-row">
                        ...
                        <p class="form-row wrap-btn">
                            <button class="btn btn-submit btn-bold basic-btn" type="submit">Sign Up</button>
                        </p>
