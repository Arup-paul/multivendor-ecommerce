...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'vendor_id' => $this->faker->boolean ? 1 : null,
            'admin_type' =>  $this->faker->boolean ? 'superadmin': 'vendor',
            ...
            'product_color' => $this->faker->randomElement(['Red','Blue','Green','Yellow','Orange','Yellow']),
